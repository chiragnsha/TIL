    ...
    override func viewDidLoad() {
        ...
        let operation = LoadModelOperation { context in
            ...
            DispatchQueue.main.async {
                ...
                self.fetchedResultsController = controller as! NSFetchedResultsController<Earthquake>
...
//            let when = dispatch_time(DISPATCH_TIME_NOW, Int64(0.3 * Double(NSEC_PER_SEC)))
            ...
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.init(uptimeNanoseconds: UInt64(0.3 * Double(NSEC_PER_SEC))), execute: {
                self.refreshControl?.endRefreshing()
            })
