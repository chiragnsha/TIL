...
//    private let serialQueue = dispatch_queue_create("Operations.ExclusivityController", DISPATCH_QUEUE_SERIAL)
    ...
    private let serialQueue = DispatchQueue.init(label: "Operations.ExclusivityController")
    
    private var operations: [String: [Operation1]] = [:]
    ...
    func addOperation(operation: Operation1, categories: [String]) {
        /*
    ...
    func removeOperation(operation: Operation1, categories: [String]) {
        serialQueue.async() {
            for category in categories {
    ...
    private func noqueue_addOperation(operation: Operation1, category: String) {
    ...
    private func noqueue_removeOperation(operation: Operation1, category: String) {
