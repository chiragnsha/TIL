...
struct LocationCondition: OperationCondition {
    ...
    */
    ...
    func evaluateForOperation(operation: Operation1, completion: (OperationConditionResult) -> Void) {
            ...
            default:
                ...
                */
                error = NSError(code: .ConditionFailed, userInfo: [
                    OperationConditionKey: type(of: self).name as Any,
                    type(of: self).locationServicesEnabledKey: enabled as Any,
                    type(of: self).authorizationStatusKey: Int(actual.rawValue) as Any
                ])
        }
...
*/
private class LocationPermissionOperation: Operation1 {
